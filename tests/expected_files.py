...
grpc_files = [
    ...
    '/myapp/grpc_services/hello/__init__.py',
    '/myapp/grpc_services/hello/v1/__init__.py',
    '/myapp/grpc_services/hello/v1/company_pb2.py',
    '/myapp/grpc_services/hello/v1/company_pb2_grpc.py',
    '/myapp/grpc_services/hello/v1/hello.py',
    '/myapp/routes.py',
    '/myapp/scripts/__init__.py',
    '/myapp/scripts/manage.py',
    '/myapp/services/__init__.py',
